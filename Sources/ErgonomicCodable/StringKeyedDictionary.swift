...
This wrapper lets us work around that by providing its custom decoding logic using the protocol `LosslessStringConvertible` to represent keys as strings.
*/
@propertyWrapper
public struct StringKeyedDictionary<Key: LosslessStringConvertible & Hashable, Value> {
